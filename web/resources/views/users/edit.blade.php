...
@section('content')
    @include('users.partials.header', ['title' => __('Editar Usuários')])
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('nome') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nome" id="input-nome" class="form-control form-control-alternative{{ $errors->has('nome') ? ' is-invalid' : '' }}" placeholder="{{ __('Nome') }}" value="{{ old('nome', $user->nome) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('usuario') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="usuario" id="input-usuario" class="form-control form-control-alternative{{ $errors->has('usuario') ? ' is-invalid' : '' }}" placeholder="{{ __('Usuário') }}" value="{{ old('usuario', $user->usuario) }}" required>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirmação de Password') }}</label>
